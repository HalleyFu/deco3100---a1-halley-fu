...
const studioDiv = document.getElementById('studioPlot');
...
Promise.all([
    ...
    const cereal_fat = unpack(cereal_data, 'fat')
...
//start of cereal
    ...
    Plotly.newPlot(cerealDiv, cereal_chart_data,cereal_chart_layout);
...
const cereal_fat_layout = {
    title: {
        text: "How much fat affects health rating"
    },
...
Plotly.newPlot(studioDiv, cereal_fat_data, cereal_fat_layout);
